...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="email" name="email" placeholder="Enter your Email" class="form-control input-md" type="text" value="<?php
if (isset($_GET['email']))
{
echo $_GET['email'];
}?>">
...
<a href="about.html" style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">About us</a></div>
