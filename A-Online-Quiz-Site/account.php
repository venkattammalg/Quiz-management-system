...
<div class="row">
<div class="col-lg-6">
<span class="logo">ChampQuiz!</span></div>
...
<center><h1 class="title" style="color:green">Result</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
        echo '<tr style="color:black"><td style="vertical-align:middle">Total Questions</td><td style="vertical-align:middle">' . $total . '</td></tr>
      <tr style="color:black"><td style="vertical-align:middle">Correct Answer&nbsp;<span class="glyphicon glyphicon-ok-arrow" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $r . '</td></tr> 
    <tr style="color:black"><td style="vertical-align:middle">Wrong Answer&nbsp;<span class="glyphicon glyphicon-remove-arrow" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $w . '</td></tr>
    <tr style="color:black"><td style="vertical-align:middle">Unattempted&nbsp;<span class="glyphicon glyphicon-ban-arrow" aria-hidden="true"></span></td><td style="vertical-align:middle">' . ($total - $r - $w) . '</td></tr>
    <tr style="color:black"><td style="vertical-align:middle">Score&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td style="vertical-align:middle">' . $s . '</td></tr>';
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">venkat ChampQuiz</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">venkat ChampQuiz</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9361234070</h4>
		<h4 style="font-family:'typo' ">venkattammal123@gmail.com</h4>
		<h4 style="font-family:'typo' ">kongu engineering college ,Erode </h4></div></div>
		</p>
      </div>
